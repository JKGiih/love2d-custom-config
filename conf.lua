function love.conf(t)
    t.identity = "Custom Config"                   -- The name of the save directory (string)
    t.version = "0.9.2"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)
    t.window.title = "Custom Config"        -- The window title (string)
    t.window.icon = nil                -- Filepath to an image to use as the window's icon (string)
    t.window.width = 800 -- 1024               -- The window width (number)
    t.window.height = 600 -- 768              -- The window height (number)
